	...
	function contenido(){
		...
		try{
			...
			echo "<table style = 'text-align:center'><tr>
					...
					<th style = 'background-color:#FFE4FD; width: 150px;'>Stock</th>
					<th style = 'background-color:#FFE4FD; width: 150px;'>Cantidad</th></tr>";
			while ($fila = $consulta2->fetch(PDO::FETCH_ASSOC)) {
				...
				echo "<td style = 'background-color:#E4F3FF'>$fila[stock]</td>";
				echo "<td style = 'background-color:#E4F3FF'>
						<form method = 'post' action =  'insertarArtCarrito.php'>
						<input type = 'number' name = 'cantidadProducto' placeholder = '0' min = '0' style = 'width: 100px;'/>
					</td>";
				echo "<td>
						<input type = 'hidden' value = '$fila[productoId]' name = 'productoId'/>
